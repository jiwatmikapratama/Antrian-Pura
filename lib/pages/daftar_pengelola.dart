                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: TextField(decoration: InputDecoration( hintText: "Nama Pengelola"),
                            style: TextStyle(
                              fontSize: 15,
                            )),
                      ),
                      Container(
                        margin: EdgeInsets.fromLTRB(20, 20, 20, 0),
                        alignment: Alignment.topLeft,
                        child: TextField( decoration: InputDecoration(hintText: "Alamat Pengelola"),
                            style: TextStyle(
                              fontSize: 15,
                            )),
                      ),
                      Container(
                        ...
                        alignment: Alignment.topLeft,
                        child: TextField( decoration: InputDecoration(hintText: "Alamat Tempat: "),
                            style: TextStyle(
                              fontSize: 15,
                            )),
                      ),
